...
use lib qw(/home/cspe/meme/lib/perl);
...
unless ($@) {
  Log::Log4perl::init('/home/cspe/meme/etc/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/home/cspe/meme/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/home/cspe/meme/etc/job_status.tmpl');
